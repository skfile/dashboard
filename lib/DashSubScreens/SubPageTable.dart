...
import 'package:dashboard/dynamicData/QPageTotal.dart';
import 'package:flutter/material.dart';

class SubPageTable extends StatelessWidget {
  const SubPageTable({Key? key}) : super(key: key);
  @override
                ...
                children: [
                  ...
                  SingleChildScrollView(
                    ...
                    child: DataTable(
                      ...
                      rows: List.generate(
                        tqueries.length,
                        (index) => recentFileDataRow(tqueries[index], context),
                      ),
                    ),
                  )
                ])));
...
DataRow recentFileDataRow(TotalQ fileInfo, BuildContext context) {
  return DataRow(
    cells: [
